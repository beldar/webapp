...
function handlenode($xmlnode,$inputstar,$thatstar,$topicstar){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="ID"){
		
		return getid();

	}
	elseif (mb_strtoupper($xmlnode["tag"])=="DATE"){

		return getfdate();

	}
	elseif (mb_strtoupper($xmlnode["tag"])=="VERSION"){

		return PROGRAMEVERSION;

	}
	elseif (mb_strtoupper($xmlnode["tag"])=="SIZE"){

		return getsize();

	}
	elseif (mb_strtoupper($xmlnode["tag"])=="STAR"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="THATSTAR"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="TOPICSTAR"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="SRAI"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="SR"){

		return respond($inputstar[0]);

	}
	elseif (mb_strtoupper($xmlnode["tag"])=="RANDOM"){
		...
		for ($randomc=0;$randomc<sizeof($children);$randomc++){
			if (mb_strtoupper($children[$randomc]["tag"]) == "LI"){
				$liarray[]=$randomc;
			}
		}
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="THINK"){

		recursechildren(realchild($xmlnode),$inputstar,$thatstar,$topicstar);
		return "";

	}
	elseif (mb_strtoupper($xmlnode["tag"])=="BOT"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="GET"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="SET"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="UPPERCASE"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="FORMAL"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="LOWERCASE"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="GENDER"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="SENTENCE"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="INPUT"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="GOSSIP"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="PERSON"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="PERSON2"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="THAT"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="CONDITION"){
...
*/
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="SYSTEM"){
	...
	/*
	elseif (mb_strtoupper($xmlnode["tag"])=="JAVASCRIPT"){
	...
	*/
	elseif (mb_strtoupper($xmlnode["tag"])=="PHP"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="JUSTBEFORETHAT"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="JUSTTHAT"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="BEFORETHAT"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="GET_IP"){

		return getid();
	
	}
	elseif (mb_strtoupper($xmlnode["tag"])=="GETNAME"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="GETSIZE"){

		return getsize();
	
	}
	elseif (mb_strtoupper($xmlnode["tag"])=="GETTOPIC"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="GETVERSION"){

		return PROGRAMEVERSION;
	
	}
	elseif (substr(mb_strtoupper($xmlnode["tag"]),0,4)=="GET_"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="SETNAME"){
	...
	elseif (mb_strtoupper($xmlnode["tag"])=="SETTOPIC"){
	...
	elseif (substr(mb_strtoupper($xmlnode["tag"]),0,4)=="SET_"){
	...
	elseif (isdeprecated(mb_strtoupper($xmlnode["tag"]),$ttag)){
	...
	elseif (iscustomtag(mb_strtoupper($xmlnode["tag"]),$ctfunction)){
